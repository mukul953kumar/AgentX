...
function Home() {
  ...
  return (
    <div className=' h-screen flex bg-[#0d0f14] text-white overflow-hidden'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda laborum voluptatum voluptate numquam expedita porro in! Quo rerum molestias repellendus odit vel saepe, temporibus itaque corrupti adipisci dolorem natus necessitatibus!
