                        ...
                        return (
                            ...
                            >
                                <div className={`flex items-center justify-center shrink-0 w-[28px] h-[28px] rounded-lg transition-colors duration-150 ${isActive
                                        ? "bg-indigo-500/15 text-indigo-400" : "bg-white/[0.05] text-slate-500"}`}>
                ...
                <div className='relative shrink-0'>
                                {
                                    ...
                                    :
                                    <div className='w-9 h-9 rounded-[10px] bg-white/[0.06] flex items-center justify-center'><User size={20} className='text-slate-600'/></div>
                    ...
                    {conversations?.map((conv, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={`flex-1 text-sm truncate transition-colors duration-150 ${isActive ? "text-indigo-400" : "text-slate-300"}`}>
                                    {conv?.title || "New Chat"}
                                </span>
                            </div>
                        )
